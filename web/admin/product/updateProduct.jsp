...
<body>
 <form method="post" action="${pageContext.request.contextPath }/admin/ProductServlet?op=updateProduct" enctype="multipart/form-data">
                        ...
                        <td width="80%" height="20" bgcolor="d3eaef" class="STYLE6">
                            <div
                                ...
                                <img width="200px" height="180px"
                                     src="${pageContext.request.contextPath}/admin/images/product/${product.imgurl}"/>
