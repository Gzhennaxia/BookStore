...
<script type="text/javascript">
	...
	function searchPage(num){
			 ...
			 var cid="${cid}";
 	         ...
 	         location.href="${pageContext.request.contextPath }/admin/ProductServlet?op=multiCondictionSearch&num="
					+ num
					+"&pid="+pid
					+"&cid="+cid 
					+"&pname="+pname 
...
<body>
						...
						<tr>
							...
							<td height="20" bgcolor="#FFFFFF">
								<div align="center" class="STYLE21">
									<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findProductForUpdate&pid=${product.pid}">编辑</a>
									|
				 ...
				 <!-- 分页的表格 -->
					...
					<tr>
						<td width="33%"><div align="left">
								<span class="STYLE22">&nbsp;&nbsp;&nbsp;&nbsp;共有<strong>${page.totalRecordsNum}</strong> 条记录，当前第<strong>${page.currentPageNum }</strong> 页，共 <strong>${page.totalPageNum}</strong> 页</span>
							 </div>
						</td>
						<td width="67%">
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="javascript:searchPage('${page.prevPageNum}')">上一页</a>
											</span>
										</div>
									</td>
									...
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="javascript:searchPage('${page.totalPageNum}')">尾页</a></span>
										</div>
									</td>
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			window.location.href = "${pageContext.request.contextPath }/admin/ProductServlet?op=multiCondictionSearch&num="
					+ num
					+"&pid="+pid
					+"&cid="+cid 
					+"&pname="+pname 
