...
<c:if test="${empty categories }">
    <jsp:forward page="/user/MainServlet"></jsp:forward>
</c:if>
        ...
        <div id="templatemo_main">
            ...
            <div id="content" class="float_r">
                ...
                <div class="content_half float_l">
                    <a rel="lightbox[portfolio]" href="${pageContext.request.contextPath}/images/product/10_l.jpg">
                        <img src="${pageContext.request.contextPath}/images/product/${product.imgurl }" style="width: 300px; height: 250px"/></a>
                </div>
